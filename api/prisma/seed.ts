...
const SEED_ACCOUNTS: Array<{
  ...
  { email: 'morgan.lee@streettaste.com', fullName: 'Morgan Lee', role: Role.STAFF, position: Position.WAITRESS, hourlyRateCents: 1650 },
  { email: 'sam.patel@streettaste.com', fullName: 'Sam Patel', role: Role.STAFF, position: Position.RUNNER, hourlyRateCents: 1800 },
]
